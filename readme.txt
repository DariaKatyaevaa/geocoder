...
Описание:   Данное приложение является геокодером для российских адресов.
...
Справка по запуску:  python geocoder.py --help
                     python geocoder.py -h

Пример запуска:      python geocoder.py  -r "Екатеринбург, проспект Ленина, 26"
